...
export const routes: RouteObject[] = [
  {
    ...
    element: <RootLayout />,
    // `lazy` 화면 주소로 **직접** 들어오면(새로고침·링크) 청크가 오기 전까지 라우터가
    // 그릴 것이 없고, 그 자리를 비워 두면 react-router 가 개발 콘솔에 «No HydrateFallback»
    // 경고를 찍습니다. 그 사이에 보여 줄 것은 실제로 없습니다 — index.html 도 빈
    // 화면이고, 청크는 같은 오리진이라 한 왕복입니다. 스피너를 넣으면 그 한 순간에
    // 깜빡임만 더합니다. 빈 폴백을 명시해 «의도한 빈 화면» 임을 라우터에 알립니다.
