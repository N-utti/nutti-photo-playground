...
const ITEM =
  'block w-full rounded-xl border border-rule-strong bg-surface px-4 py-3 text-center text-sm font-semibold hover:border-brand-2 hover:bg-brand-soft hover:text-brand motion-safe:active:scale-[0.99]'
