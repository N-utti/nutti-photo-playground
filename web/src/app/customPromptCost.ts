 ...
 * 이 숫자는 두 화면의 **문장 안에** 들어갑니다 — 홈 스타일 목록 끝 카드 · W-08 만들기
 * 버튼(한때 W-04 업로드 후 링크도 있었습니다). 흩어 놓으면 값이 바뀌는 날 한 곳만
 * 고쳐지고, 남은 화면이 «2 크레딧» 이라고 말하며 3 을 빼 갑니다.
 *
...
/**
 * W-08 진입 버튼 라벨(app/CustomPromptEntry.tsx — 홈 스타일 목록 끝 카드).
 *
 * 카드가 말하는 비용과 W-08 버튼이 말하는 비용이 같아야 해서 여기서 만듭니다. 한쪽만
