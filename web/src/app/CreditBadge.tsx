 ...
 *
 * 두 문장 사이의 줄바꿈은 의도입니다 — 앞은 «왜 이 창이 떴는가», 뒤는 «로그인하면
 * 어떻게 되는가» 로 하는 말이 다릅니다. 한 줄로 이으면 시트 폭에서 둘째 문장이
 * 어중간한 곳에서 꺾입니다. AccountSheet 가 `whitespace-pre-line` 으로 그대로 그립니다.
 */
export const GUEST_EARN_DESCRIPTION =
  '크레딧 받기는 회원만 할 수 있어요.\n로그인하면 지금까지 만든 결과도 그대로 이어집니다.'
