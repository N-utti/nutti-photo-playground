 ...
 *
 * **`?pet_id=` 는 세 갈래를 다 냅니다.** 서버는 **그 강아지에 저장된 견종을 1순위**로 보고,
 * 없을 때만 최신 사진에 적힌 값으로 내려갑니다(`app/routers/results.py` `_resolve_pet_and_estimate`,
 * 백엔드 #211). 그래서 «사진은 없어도 견종은 아는» 강아지는 계산기 2단계부터 시작하고,
 * 둘 다 없어야 `breed_code: null` 로 와서 1단계부터입니다(FR-EDGE-10). 그리고 **없는
