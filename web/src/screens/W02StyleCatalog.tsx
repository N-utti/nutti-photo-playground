 ...
 * 안 그립니다 — **아직 물어보지 않았기 때문**입니다. 견종은 W-04 확인 단계에서
 * 사용자가 목록에서 고르거나 직접 쓰는 값이라(백엔드 #210 이 비전 추정을 폐기),
 * 그 앞인 이 화면에서는 무엇이 박힐지 알 방법이 없습니다. 말할 수 있는 자리는
 * 그래서 W-04 하나뿐이고, 판단 근거는 screens/W03StyleDetail.tsx 헤더에 한
 * 곳으로 적어 뒀습니다.
 */
